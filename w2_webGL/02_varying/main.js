...
const VS_SOURCE = `
    ...
    // two attributes expecting to be provided
    attribute vec4 aVertexPosition;
    attribute vec4 aVertexColor;
    
    // a varying is a value getting passed to frag shader
    varying vec4 vColor;
...
function main() {
    ...
    // try to grab the color information as well
    ...
    gl.vertexAttribPointer(vertex_color_location, 3, gl.FLOAT, false, 0, 0);
